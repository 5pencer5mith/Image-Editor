...
public class ImageEditor extends ApplicationAdapter {
	...
	private void createGraphicalElements() {
		...
		new ColorButton(new Vector2(42, 42), new Vector2(42, 42), Color.WHITE);
		new ColorButton(new Vector2(42, 42), new Vector2(0, 42), Color.BLACK);
		...
		new ColorButton(new Vector2(42, 42), new Vector2(0, 168), Color.PURPLE);
		new ColorButton(new Vector2(42, 42), new Vector2(42, 168), Color.PINK);
		new ColorButton(new Vector2(42, 42), new Vector2(0, 210), Color.BROWN);
